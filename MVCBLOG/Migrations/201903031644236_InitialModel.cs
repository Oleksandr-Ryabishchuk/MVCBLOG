    ...
    public partial class InitialModel : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AspNetUsers", t => t.CreatedByUserId, cascadeDelete: false)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Themes", "CreatedByUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Posts", "CreatedByUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropIndex("dbo.AspNetRoles", "RoleNameIndex");
            DropIndex("dbo.Themes", new[] { "CreatedByUserId" });
